...
* DOMAIN 값을 불러와서 LT_DDTEXT에 담는다.
CALL FUNCTION 'DD_DOMVALUES_GET'
  EXPORTING
    DOMNAME         = 'S_CUSTTYPE'    " Domain 값을 넣으면 된다. "
    TEXT            = 'X'
  TABLES
    DD07V_TAB      = LT_DDTEXT    " Function Module Table에서 선언된 타입으로 선언 "
  EXCEPTIONS
    VALUE_NOT_FOUND = 1
    OTHERS          = 2.
...
LOOP AT GT_LIST INTO GS_LIST.
  ...
  WITH KEY DOMVALUE_L = GS_LIST-CUSTTYPE
  INTO LS_DDTEXT.
